...
guard = "(store <> 'NOON_MINUTES' or coalesce(debug_info, '') <> 'noon-product-page-live-fallback')"

if control.count(guard) < 4:
    raise SystemExit("unverified Noon fallback is not excluded from all public price views")
